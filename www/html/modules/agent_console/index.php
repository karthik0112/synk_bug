...
function manejarSesionActiva_HTML($module_name, &$smarty, $sDirLocalPlantillas, $oPaloConsola, $estado, $listpanels)
{
    ...
    $smarty->assign(array(
        ...
        'BTN_VTIGERCRM'                 =>  _tr('CRM'),
        'BTN_FINALIZAR_LOGIN'           =>  "<a target='_blank'  href=ssologout.php?extension={$_SESSION["callcenter"]["extension"]}>End session</a>",
        ...
        'IVRCRM' => "<a target='_blank' href=sso.php?extension={$_SESSION["callcenter"]["extension"]}>CRM</a>",
