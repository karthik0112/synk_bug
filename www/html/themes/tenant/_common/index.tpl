  ...
  <head>
    ...
    <div class="page-container">
        ...
        <footer class="main" style="margin-left:16px;">
            <a  style="color: #444; text-decoration: none;" target='_blank'>Powered by  </a>  <a href="https://yavar.in" target='_blank' style="color: #000000; text-decoration: bold;" >Yavar Techworks </a> - {$currentyear}.
        </footer>
