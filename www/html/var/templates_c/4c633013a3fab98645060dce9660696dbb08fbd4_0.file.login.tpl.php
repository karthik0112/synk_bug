<?php
/* Smarty version 3.1.33, created on 2022-10-21 02:24:35
  from '/var/www/html/themes/tenant/_common/login.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_63523b233fa451_49238424',
...
function content_63523b233fa451_49238424 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="login-container">
	...
	<div class="login-header login-caret" style="padding:50px 10px 0 0;">

		<div class="login-content">

			<!--<img src="images/brand-logo.png" width=150" height="100" alt="Issabel logo">
...
" autocomplete="off" />
			...
			<div class="login-bottom-links">
                        <img src="images/brand-logo.png" style="padding:top" width="150" height="40" alt="Issabel logo" ><br><br>
 <a> Powered by </a><a href="https://yavar.in" style="text-decoration: none;" target='_blank'>Yavar Techworks</a> <?php echo $_smarty_tpl->tpl_vars['currentyear']->value;?>
.</div>
			</div>
